...
def main(override_config: OmegaConf):
    ...
    if EXPORT_POLICY:
        # print("aaaaaaaaaaaaaaaaawywywywywyy")
        ######就是这一行代码，其中algo有问题的，algo.alg.actor_critic是在干吗？
        # export policy as a jit module (used to run it from C++)

        #这里相当于没有实现actor_critic

        print(algo.actor)
        print(algo.critic)
        print(exported_policy_path)
        print(exported_policy_name)
